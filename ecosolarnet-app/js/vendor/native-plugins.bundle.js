(() => {
  ...
  var init_esm = __esm({
    "node_modules/@capacitor-community/text-to-speech/dist/esm/index.js"() {
      ...
      TextToSpeech = registerPlugin("TextToSpeech", {
        web: () => Promise.resolve().then(() => (init_web(), web_exports)).then((m) => new m.TextToSpeechWeb())
      });
      if ("speechSynthesis" in window) {
  ...
  var init_esm2 = __esm({
    "node_modules/@capacitor-community/speech-recognition/dist/esm/index.js"() {
      init_dist();
      init_definitions2();
      SpeechRecognition2 = registerPlugin("SpeechRecognition", {
  ...
  var init_esm6 = __esm({
    "node_modules/@capacitor/app/dist/esm/index.js"() {
      ...
      App = registerPlugin("App", {
        web: () => Promise.resolve().then(() => (init_web6(), web_exports6)).then((m) => new m.AppWeb())
      });
    }
  });
  ...
  var require_entry = __commonJS({
    "build-tmp/entry.js"() {
      ...
      init_esm5();
      init_esm6();
      window.NativeTTS = TextToSpeech;
      window.NativeSpeechRecognition = SpeechRecognition2;
      window.NativeFilesystem = Filesystem;
      window.NativeShare = Share;
      window.NativeBrowser = Browser2;
      window.NativeApp = App;
    }
  });
  require_entry();
})();
